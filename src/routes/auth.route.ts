...
router.post(
  ...
  body("nik")
    ...
    .withMessage("Mohon isikan nomor induk kependudukan."),
  body("phone_number")
    .not()
    .isEmpty()
    .withMessage("Mohon isikan nomor telepon."),
  ...
  body("gender")
    .isString()
    .matches(/^[M|F]{1}$/)
    .withMessage("Mohon isikan jenis kelamin."),
  body("date_of_birth")
    .not()
    .isEmpty()
    .withMessage("Mohon isikan tanggal lahir."),
...
router.post("/token", authHelper.authMiddleware, authController.register_token);
