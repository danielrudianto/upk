            ...
            prisma.user_transaction
                ...
                switch (payment.id) {
                    case 1:
                        ...
                        bank_service_1.default.createVirtualAccount(result.user.id.toString().padStart(10, "0"), result.user.name, value + service - discount, `Transaksi AbangKu #${result.id}`, expired)
                            .then((result) => {
