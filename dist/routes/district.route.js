...
router.get("/provinsi", [
    (0, express_validator_1.query)("keyword").isString().isLength({ min: 3 }).withMessage("Mohon masukkan 3 karakter atau lebih.")
...
router.get("/kecamatan/:city_id", [
    (0, express_validator_1.query)("keyword").isString().isLength({ min: 2 }).withMessage("Mohon masukkan 2 karakter atau lebih.")
], district_controller_1.default.getKecamatanAutocomplete);
router.get("/kelurahan/:kecamatan_id", [
    (0, express_validator_1.query)("keyword").isString().isLength({ min: 2 }).withMessage("Mohon masukkan 3 karakter atau lebih.")
